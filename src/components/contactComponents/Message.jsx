    ...
    return (
        <section id="message" className="mt-5 py-5">
            <div className="container pb-5 mb-5">
                ...
                <div className="row message-responsive justify-content-between">
                    <div className="col-6">
                        <form>
                            <div className="form-group mb-5">
                                <label className="text-uppercase" htmlFor="exampleInputEmail1">Name *</label>
                                <input  type="text" className="form-control size-18 py-4 pl-4 rounded-0" id="name" aria-describedby="emailHelp" required/>
                            </div>
                            <div className="form-group mb-5">
                                <label className="text-uppercase" htmlFor="exampleInputPassword1">Email *</label>
                                <input  type="email" className="form-control size-18 py-4 pl-4 rounded-0" id="email" required/>
                            </div>
                            <div className="form-group mb-5">
                            ...
                            <div className="form-group">
                                ...
                                <textarea name="message" id="meassage" cols="30" rows="5" className="w-100 outline-0 pl-4 size-18" required></textarea>
                            </div>
                    ...
                    <div className="col-5">
                        <div className="col-12 row mb-5">
                            ...
                            <div className="detail">
                                ...
                                <p className="size-18 m-0 font-weight-lighter">342 Sloane St, London</p>
                            </div>
                        </div>
                        <div className="col-12 row mb-5">
