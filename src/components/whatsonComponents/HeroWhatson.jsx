...
const HeroWhatson = () => {
    return(
        <motion.section id="heroWhatson" className="position-relative">
            <div className="seach-input container position-absolute bg-white b-0 z-index-1 px-5 pt-5 border-radius-3 border-bottom-radius-none center-x ">
            ...
            <div id="carouselMovie" className="carousel slide w-100 h-100 h-45rem" data-ride="carousel">
                <div className="carousel-inner w-100 h-100">
                    <div id="carouselHero" className="carousel-item w-100 h-100 active">
                        <img src={heroWhatson} className="d-block w-100 h-100 object-fit-cover" alt="..." />
