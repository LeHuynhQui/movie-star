                ...
                <nav className="navbar flex-nowrap justify-content-between nav-responsive">
                    ...
                    <ul className={close ? "list-unstyled border-bottom main-nav active" : "list-unstyled border-bottom main-nav"}>
                        <li className="nav-item hover-border-effect d-inline-block">
                            <a className={resize ? "nav-link pages px-4 py-4 position-relative text-white active" : "nav-link pages px-4 py-4 letter-spacing-3 position-relative text-white active"}  href="/">HOME</a>
                        </li>
                        <li className="nav-item hover-border-effect d-inline-block">
                            <a className={resize ? "nav-link pages px-4 py-4 position-relative text-white" : "nav-link pages px-4 py-4 letter-spacing-3 position-relative text-white"} href="/whats-on">WHAT'S ON</a>
                        </li>
                        <li className="nav-item hover-border-effect d-inline-block">
                            <a className={resize ? "nav-link pages px-4 py-4 position-relative text-white" : "nav-link pages px-4 py-4 letter-spacing-3 position-relative text-white"} href="/shortcodes">SHORTCOEDS</a>
                        </li>
                        <li className="nav-item hover-border-effect d-inline-block position-relative news">
                            <a className={resize ? "nav-link pages px-4 py-4 position-relative text-white" : "nav-link pages px-4 py-4 letter-spacing-3 position-relative text-white"} href="/news">NEWS</a>
                        ...
                        <li className="nav-item hover-border-effect d-inline-block">
                            <a className={resize ? "nav-link pages px-4 py-4 position-relative text-white" : "nav-link pages px-4 py-4 letter-spacing-3 position-relative text-white"} href="/contact">CONTACT</a>
                        </li>
                    </ul>
                </nav>
            </div>
